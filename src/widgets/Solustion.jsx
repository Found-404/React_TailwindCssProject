  ...
  return (
    <div>
      ...
      <div className='grid lg:grid-cols-2 mt-20 gap-20'>
            <div className='mt-7 text-[32px] font-fold'>
                <h3 className='mt7 text-[32px] font-fold'>强有力的工具</h3>
                <p className='mt-4 mb-8 text-gray-500'>
                    强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具强有力的工具
                </p>
                <ul className='grid gap-3'>
                    {
                        [1,2,3].map(v=>{
                            return <li className={`p-5 justify-between rounded border border-zinc-100 
                            ${v==1 &&"bg-zinc-100"}`} key={v}>
                                ...
                                <div className='flex justify-between relative'>
                                    <p className='text-lg leading-7 mt-1'>
                                        简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态简单的生态
                                    </p>
                                    <svg
                                    width="38"
                                    height="38"
